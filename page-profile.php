...
/**
 * Template Name: Страница "Мои обьявления"
 */
...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <article class="post page" id="pageid-<?php the_ID(); ?>">
        ...
        <div class="entry-box clearfix">
            ...
            <form data-ajax data-success_event="modalOpenHtml" class="mb-1">
                <input type="hidden" name="action" value="basic_create_item">
                <input type="submit" name="button" class="button" value="Создать объявление" />
            </form>
