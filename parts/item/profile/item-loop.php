<a href="<?php the_permalink() ?>" class="ad-object-item">
    <div class="ad-object-content">
        <div class="ad-object-thumb">
            <img src="<?php echo get_field('screenshot')['sizes']['large'] ?>" class="ad-object-thumb-img" alt="<?php echo get_field('screenshot')['title'] ?>">
        </div>
        <div class="ad-object-description">
            ...
            <?php echo get_template_part('parts/item/profile/item', 'buttons') ?>
        </div>
    </div>
</a>